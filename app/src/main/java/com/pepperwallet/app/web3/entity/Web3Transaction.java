...
import com.pepperwallet.app.util.Hex;
import com.pepperwallet.app.util.StyledStringBuilder;
...
public class Web3Transaction implements Parcelable {
     ...
     * @param minGas
     */
    public Web3Transaction(com.pepperwallet.app.entity.Transaction tx, ActionSheetMode mode, BigInteger minGas)
    {
